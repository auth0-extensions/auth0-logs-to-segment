...
/***/ function(module, exports, __webpack_require__) {
	...
	var Segment = __webpack_require__(18);
	var app = express();
	...
	function lastLogCheckpoint(req, res) {
	  ...
	  var required_settings = ['AUTH0_DOMAIN', 'AUTH0_CLIENT_ID', 'AUTH0_CLIENT_SECRET', 'SEGMENT_KEY'];
	  ...
	  req.webtaskContext.storage.get(function (err, data) {
	    ...
	    var analytics = new Segment(ctx.data.SEGMENT_KEY);
	    ...
	    async.waterfall([function (callback) {
	      ...
	      context.logs = context.logs.filter(function (l) {
	        return ['s', 'ss', 'f'].indexOf(l.type) !== -1;
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	const LRU        = __webpack_require__(20);
